    ...
    <div class="technical-service">
        ...
        <el-form-item label="Root Category">
          <el-select v-model="formSearch.root_category_id" placeholder="Root Category">
            ...
            <div class="btn-group-top">
                <div class="icons">
                    <div class="icon-item add-v2" @click="dialogAdd" v-ilpermission="'technical-service-user-add'"  title="add"></div>
                </div>
            </div>
        </div>
                ...
                <table class="table-content" border="0" cellspacing="0" cellpadding="0" v-else>
                    ...
                    <tbody v-if="!loading && tableList.length > 0">
                        <tr v-for="item in tableList" :key="item.id">
                            ...
                            <td>
                                <a class="btn-underline" v-ilpermission="'technical-service-user-add'" @click.stop="onEdit(item)">edit</a>
                                <a class="btn-underline" v-ilpermission="'technical-service-user-delete'" @click.stop="onDelete(item)">delete</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        >
            ...
            <div class="item">
                ...
                <div class="content">
                    <el-input v-model="formData.kf_fullName" placeholder="Full Name"></el-input>
                </div>
            </div>
            <div class="item">
            ...
            <div class="item">
                ...
                <div class="content">
                    <el-input v-model="formData.specialty" placeholder="Specialty"></el-input>
                </div>
            </div>
        ...
        <!-- 删除弹窗 -->
        <el-dialog title="Delete Technical Service User" :visible.sync="dialogDeleteVisible" size="tiny">
...
export default {
  ...
  methods: {
    ...
    onEdit(event) {
      ...
      this.dialogTitle = "Update Technical Service User";
    ...
    // 添加
    dialogAdd() {
      this.dialogTitle = "Add Technical Service User";
      this.dialogVisible = true;
      this.formData = {
        employee_no: "",
        kf_fullName: "",
...
// WEBPACK FOOTER //
// technical-service-user.vue?38f72188